...
% Dentro de estas funciones, nos encontramos con:

% \begin{itemize}
%     \item \textit{sched\_setup()}: Función que inicializa el planificador 4BSD con las \textit{run queues}.
%     \item 
