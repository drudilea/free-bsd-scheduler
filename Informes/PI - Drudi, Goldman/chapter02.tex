...
Los puntos clave para la toma de decisiones se encuentran en los momentos en que un hilo debe ceder el uso de la CPU a otro, creando la ilusión de concurrencia en la ejecución de múltiples hilos. En el contexto del planificador 4BSD de FreeBSD, esto implica desencolar un hilo de la cola de hilos RUNNABLE y pasarlo a ejecución, mientras que el hilo que estaba utilizando la CPU se reencola en una de las colas de ejecución.

En este punto es donde se centró el trabajo integrador previo: modelar el sistema de encolado y desencolado de hilos utilizando una Red de Petri. Esta técnica permite representar de manera precisa y formal los estados y transiciones de los hilos, mejorando así la eficiencia y previsibilidad del planificador.
...
% - Hablar un poco del file sched_4bsd.c
