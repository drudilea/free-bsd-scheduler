...
\textcolor{red}{ESCRIBIR ALGO SOBRE LAS HERRAMIENTAS QUE SE IMPLEMENTARAN A LA HORA DE LOS ANÁLISIS.}
...
\textcolor{red}{IMAGEN CON PROCESADOR SUSPENDIDO}

En relación al tiempo necesario para completar el cálculo del programa, notamos que dicho tiempo aumentó proporcionalmente a la disminución en el número de procesadores activos, destacando la correlación entre la disponibilidad de recursos de procesamiento y el tiempo total requerido para finalizar el programa. En la \textcolor{red}{FIGURA TANTO} podemos comprobar el funcionamiento del sistema con la inhabilitación simultánea de dos procesadores.\par

\textcolor{red}{IMAGEN CON DOS PROCESADORES SUSPENDIDOS}
...
\textcolor{red}{branch con el codigo}
...
\textcolor{red}{ENCONTRAR UNA FORMA DE MOSTRAR COMO LOS HILOS SE PLANIFICAN SIN TENER EN CUENTA LA MONOPOLIZACION, CAMBIANDO SU EJECUCION ENTRE LOS DISTINTOS NUCLEOS}
...
\textcolor{red}{2 imágenes con los subprocesos, que se pueda ver una comparación de cómo cambia el CPU para alguno de los subprocesos, es decir, subproceso 1 primer imagen corre en el cpu 1, segunda imagen ese mismo subproceso corre en cpu 3}
...
\textcolor{red}{Imagen con el hilo asociado al núcleo, quizás también podemos tener un link a video para mostrar hasta que termina de ejecutarse, y con la desactivación del módulo para ver como el cpu vuelve a estar disponible para los otros procesos}
...
\textcolor{red}{MOSTRAR ALGUNAS IMAGENES DEL PROYECTO CORRIENDO CON LA VERSION 13.1 Y UTILIZANDO LA RED}

\subsection{Resultados del tareas extra \textcolor{red}{OPCIONAL - VER SI LO AGREGAMOS}}
