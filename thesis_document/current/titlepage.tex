\begin{titlepage}
    \begin{center}
        ...
        \huge
        \textbf{Modelado y Extensión de un Planificador del Sistema Operativo mediante Redes de Petri} \\

        \vspace{.5cm}
        \large
        \textbf{Integración de Funcionalidades de Monopolización de Núcleos e Inhibición de Asignación de Trabajo a Procesadores} \\
        ...
        \normalsize
        \textbf{Email:} leandro.drudi@mi.unc.edu.ar, nicolasgoldman@mi.unc.edu.ar
