...
\begin{itemize}
    ...
    \item Validar la hipótesis de que un planificador basado en Redes de Petri permite una integración más sencilla y modular de nuevas funcionalidades. Para ello, se desarrollarán dos módulos:
    \begin{itemize}
