...
Estos resultados confirman que el sistema es capaz de gestionar dinámicamente la activación y desactivación de procesadores sin comprometer su estabilidad.\par
...
Basándonos en las observaciones anteriores, llevamos a cabo la misma prueba de estrés, pero activando previamente el módulo de encendido/apagado para inhabilitar la CPU2.\par
