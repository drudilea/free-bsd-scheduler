...
\subsection{Métodos de interés para nuestra tesis}
...
\begin{itemize}
    ...
    \item Selección del hilo a ejecutar: En la función que elige el próximo hilo a ejecutar, se gestionan los hilos de la cola global, las colas de los procesadores y el hilo \textit{idlethread}, ejecutado en casos de ausencia de otros hilos listos.
